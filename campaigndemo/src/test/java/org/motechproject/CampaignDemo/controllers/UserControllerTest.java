...
public class UserControllerTest {
    ...
    public void testAddUser() {
        ...
        verify(patientDAO, Mockito.atMost(1)).update(
                Matchers.any(Patient.class));
    ...
    public void testRemoveUser() {
        ...
        verify(patientDAO, Mockito.atLeast(1)).removePatient(
                Matchers.any(String.class));
        verify(patientDAO, Mockito.atMost(1)).removePatient(
                Matchers.any(String.class));
