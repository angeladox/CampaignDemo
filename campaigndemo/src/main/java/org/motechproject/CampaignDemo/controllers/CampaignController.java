...
public class CampaignController extends MultiActionController {
    ...
    public ModelAndView start(HttpServletRequest request,
        ...
        DateTime startDateTime = now.plusMinutes(offsetValue);
        Integer startHour = startDateTime.getHourOfDay();
        Integer startMinutes = startDateTime.getMinuteOfHour();
        Time startTime = new Time(startHour, startMinutes);
        /**
        ...
        campaignRequest.setStartTime(startTime);
        ...
        if (("Cron based SMS Program").equals(campaignName)
                || ("Cron based IVR Program").equals(campaignName)) {
